package dev.junior.ccos.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import dev.junior.ccos.IntegrationTest;
import dev.junior.ccos.repository.timezone.DateTimeWrapper;
import dev.junior.ccos.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM m2gdil_date_time_wrapper where id=%d", fieldName, id);
    }
